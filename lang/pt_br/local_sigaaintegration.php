...
$string['importenrollments'] = 'Importar matrículas de discentes';
$string['importservantenrollments'] = 'Importar matrículas de docentes';
$string['importstudents'] = 'Importar Estudantes';
$string['importservants'] = 'Importar Professores';
$string['importcourses'] = 'Importar disciplinas';
