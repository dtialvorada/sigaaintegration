...
use local_sigaaintegration\sigaa_enrollments_teachers_sync;
use local_sigaaintegration\sigaa_academic_period;

class import_enrollments_teachers_task extends scheduled_task {
    ...
    public function execute() {
        ...
        $enrollmentssync = new sigaa_enrollments_teachers_sync($period->getAno(), $period->getPeriodo());
